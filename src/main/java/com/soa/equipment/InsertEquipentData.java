...
public class InsertEquipentData extends HttpServlet {	
	...
	protected void service(HttpServletRequest request,
		...
		if( EQU_POSITION_NUM != null ){
			...
			try {
				...
				if( i > 0) {
					...
					String condition = modify.createUpdateCondition( WEL_NAME, WEL_UNIT, EQU_MEMO_ONE, 
		...
		String condition = createInsertCondition( EQU_ID,
				SECONDCLASS_EQUIPMENT, WEL_NAME, WEL_UNIT, EQU_MEMO_ONE, 
				EQU_POSITION_NUM, EQU_NAME,//通用
				MANAGE_TYPE, EQU_MODEL, MEARING_RANGE, MEASURE_ACC,
				EQU_INSTALL_POSITION, EQU_MANUFACTURER, SERIAL_NUM,
				CHECK_CYCLE, CHECK_TIME, NEXT_CHECK_TIME, REMARK1,//压力表
	    ...
	    /**
	    * @Title: createInsertCondition
	    * @Description: 生成插入条件
	    * @param @param SECONDCLASS_EQUIPMENT
	...
	private String createInsertCondition( String EQU_ID,
			String SECONDCLASS_EQUIPMENT, String WEL_NAME, String WEL_UNIT, 
		...
		condition = condition + "'" + EQU_ID + "','" +
				SECONDCLASS_EQUIPMENT + "','" + WEL_NAME + "','" + WEL_UNIT + "','" + 
				EQU_MEMO_ONE + "','" + EQU_POSITION_NUM + "','" + EQU_NAME + "','" + 
				MANAGE_TYPE + "','" + EQU_MODEL + "','" + MEARING_RANGE + "','" + 
				MEASURE_ACC + "','" + EQU_INSTALL_POSITION + "','" + EQU_MANUFACTURER + "','" + 
				SERIAL_NUM + "','" + CHECK_CYCLE + "','" + CHECK_TIME + "','" + 
				NEXT_CHECK_TIME + "','" + 
				REMARK1 + "','" + 
				MEDUIM_TYPE + "','" + 
			EQU_PRODUC_DATE + "','" + 
