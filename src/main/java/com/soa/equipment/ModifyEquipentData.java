...
public class ModifyEquipentData extends HttpServlet {	
	...
	protected void service(HttpServletRequest request,
		...
		String initsql = " select count(*) as NUM from  iot_equipment_operate_recode where EQU_POSITION_NUM='" + EQU_POSITION_NUM + "'";
		try {
...
//					condition.substring(condition.indexOf("where"), condition.length());
	...
	public String createUpdateCondition(
		...
		if(	EQU_PRODUC_DATE	!= null   ) {	condition = condition + " 	EQU_PRODUC_DATE	='"	+	EQU_PRODUC_DATE	+	"',";}
		if(	EQU_COMMISSION_DATE	!= null   ) {	condition = condition + " 	EQU_COMMISSION_DATE	='"	+	EQU_COMMISSION_DATE	+	"',";}
		if(	EQU_WORK_TEMP	!= null   ) {	condition = condition + " 	EQU_WORK_TEMP	='"	+	EQU_WORK_TEMP	+	"',";}
		if(	EQU_LASTPERIODIC_DATE	!= null   ) {	condition = condition + " 	EQU_LASTPERIODIC_DATE	='"	+	EQU_LASTPERIODIC_DATE	+	"',";}
		if(	EQU_PERIODIC_CYCLE	!= null   ) {	condition = condition + " 	EQU_PERIODIC_CYCLE	='"	+	EQU_PERIODIC_CYCLE	+	"',";}
		if(	EQU_PERIODIC_WARNDAYS	!= null   ) {	condition = condition + " 	EQU_PERIODIC_WARNDAYS	='"	+	EQU_PERIODIC_WARNDAYS	+	"',";}
		if(	PRESSURE_RANGE	!= null   ) {	condition = condition + " 	PRESSURE_RANGE	='"	+	PRESSURE_RANGE	+	"',";}
		if(	EXPERY_TIME	!= null   ) {	condition = condition + " 	EXPERY_TIME	='"	+	EXPERY_TIME	+	"',";}
		if(	INTER_SIZE	!= null   ) {	condition = condition + " 	INTER_SIZE	='"	+	INTER_SIZE	+	"',";}
		if(	DEEP_LENGTH	!= null   ) {	condition = condition + " 	DEEP_LENGTH	='"	+	DEEP_LENGTH	+	"',";}
		if(	ORDER_NUM	!= null   ) {	condition = condition + " 	ORDER_NUM	='"	+	ORDER_NUM	+	"',";}
		if(	VAVLE_TYPE	!= null   ) {	condition = condition + " 	VAVLE_TYPE	='"	+	VAVLE_TYPE	+	"',";}
		if(	ACTION_MODLE	!= null   ) {	condition = condition + " 	ACTION_MODLE	='"	+	ACTION_MODLE	+	"',";}
		if(	HAVE_NOT	!= null   ) {	condition = condition + " 	HAVE_NOT	='"	+	HAVE_NOT	+	"',";}
		if(	ACTUAL_MODEL	!= null   ) {	condition = condition + " 	ACTUAL_MODEL	='"	+	ACTUAL_MODEL	+	"',";}
		if(	ACTUAL	!= null   ) {	condition = condition + " 	ACTUAL	='"	+	ACTUAL	+	"',";}
		if(	ELEC_MODEL	!= null   ) {	condition = condition + " 	ELEC_MODEL	='"	+	ELEC_MODEL	+	"',";}
		if(	ELEC	!= null   ) {	condition = condition + " 	ELEC	='"	+	ELEC	+	"',";}
		if(	MEASURE_PRIN	!= null   ) {	condition = condition + " 	MEASURE_PRIN	='"	+	MEASURE_PRIN	+	"',";}
		if(	PIPE_OUTER	!= null   ) {	condition = condition + " 	PIPE_OUTER	='"	+	PIPE_OUTER	+	"',";}
		if(	FLUX	!= null   ) {	condition = condition + " 	FLUX	='"	+	FLUX	+	"',";}
		if(	PIPE_THICK	!= null   ) {	condition = condition + " 	PIPE_THICK	='"	+	PIPE_THICK	+	"',";}
		if(	CV	!= null   ) {	condition = condition + " 	CV	='"	+	CV	+	"',";}
		if(	POSITIONER	!= null   ) {	condition = condition + " 	POSITIONER	='"	+	POSITIONER	+	"',";}
		if(	GAS_SOURCE	!= null   ) {	condition = condition + " 	GAS_SOURCE	='"	+	GAS_SOURCE	+	"',";}
		if(	FLA_SIZE	!= null   ) {	condition = condition + " 	FLA_SIZE	='"	+	FLA_SIZE	+	"',";}
		if(	PROCE_LINK_TYPE	!= null   ) {	condition = condition + " 	PROCE_LINK_TYPE	='"	+	PROCE_LINK_TYPE	+	"',";}
		if(	UNIT	!= null   ) {	condition = condition + " 	UNIT	='"	+	UNIT	+	"',";}
		if(	COUNT	!= null   ) {	condition = condition + " 	COUNT	='"	+	COUNT	+	"',";}
		if(	POWER_RATE	!= null   ) {	condition = condition + " 	POWER_RATE	='"	+	POWER_RATE	+	"',";}
		if(	ELECTRIC_PRES	!= null   ) {	condition = condition + " 	ELECTRIC_PRES	='"	+	ELECTRIC_PRES	+	"',";}
		if(	ELECTRIC_TENSION	!= null   ) {	condition = condition + " 	ELECTRIC_TENSION	='"	+	ELECTRIC_TENSION	+	"',";}
		if(	FREQUENCY	!= null   ) {	condition = condition + " 	FREQUENCY	='"	+	FREQUENCY	+	"',";}
		if(	BRAND	!= null   ) {	condition = condition + " 	BRAND	='"	+	BRAND	+	"',";}
		if(	CAPCITY	!= null   ) {	condition = condition + " 	CAPCITY	='"	+	CAPCITY	+	"',";}
		if(	SPEED_RAT	!= null   ) {	condition = condition + " 	SPEED_RAT	='"	+	SPEED_RAT	+	"',";}
		if(	BEFORE_BEARING1	!= null   ) {	condition = condition + " 	BEFORE_BEARING1	='"	+	BEFORE_BEARING1	+	"',";}
		if(	BEFORE_BEARING2	!= null   ) {	condition = condition + " 	BEFORE_BEARING2	='"	+	BEFORE_BEARING2	+	"',";}
		if(	AFTER_BEARING1	!= null   ) {	condition = condition + " 	AFTER_BEARING1	='"	+	AFTER_BEARING1	+	"',";}
		if(	GREASE_INTERV	!= null   ) {	condition = condition + " 	GREASE_INTERV	='"	+	GREASE_INTERV	+	"',";}
		if(	GREASE_QUAN	!= null   ) {	condition = condition + " 	GREASE_QUAN	='"	+	GREASE_QUAN	+	"',";}
		if(	INSULATION_RATE	!= null   ) {	condition = condition + " 	INSULATION_RATE	='"	+	INSULATION_RATE	+	"',";}
		if(	PROTECTION_RATE	!= null   ) {	condition = condition + " 	PROTECTION_RATE	='"	+	PROTECTION_RATE	+	"',";}
		if(	EXPLOSION_RATE	!= null   ) {	condition = condition + " 	EXPLOSION_RATE	='"	+	EXPLOSION_RATE	+	"',";}
		if(	DEVICE_TYPE	!= null   ) {	condition = condition + " 	DEVICE_TYPE	='"	+	DEVICE_TYPE	+	"',";}
		if(	HEIGHT_ELECTRIC_TENSION	!= null   ) {	condition = condition + " 	HEIGHT_ELECTRIC_TENSION	='"	+	HEIGHT_ELECTRIC_TENSION	+	"',";}
		if(	PHASE_NUMBER	!= null   ) {	condition = condition + " 	PHASE_NUMBER	='"	+	PHASE_NUMBER	+	"',";}
		if(	CONNECTION_GROUP	!= null   ) {	condition = condition + " 	CONNECTION_GROUP	='"	+	CONNECTION_GROUP	+	"',";}
		if(	HEIGHT_ELECTRIC_PRES	!= null   ) {	condition = condition + " 	HEIGHT_ELECTRIC_PRES	='"	+	HEIGHT_ELECTRIC_PRES	+	"',";}
		if(	WEIGHT	!= null   ) {	condition = condition + " 	WEIGHT	='"	+	WEIGHT	+	"',";}
		if(	SNATCH_ELECTRIC_PRES	!= null   ) {	condition = condition + " 	SNATCH_ELECTRIC_PRES	='"	+	SNATCH_ELECTRIC_PRES	+	"',";}
		if(	THUNDERSTRIKE_ELECTRIC_PRES	!= null   ) {	condition = condition + " 	THUNDERSTRIKE_ELECTRIC_PRES	='"	+	THUNDERSTRIKE_ELECTRIC_PRES	+	"',";}
		if(	SNATCH_ELECTRIC_TENSION	!= null   ) {	condition = condition + " 	SNATCH_ELECTRIC_TENSION	='"	+	SNATCH_ELECTRIC_TENSION	+	"',";}
		if(	PEAK_TENSION	!= null   ) {	condition = condition + " 	PEAK_TENSION	='"	+	PEAK_TENSION	+	"',";}
		if(	CATEGORY	!= null   ) {	condition = condition + " 	CATEGORY	='"	+	CATEGORY	+	"',";}
		if(	MATERIAL	!= null   ) {	condition = condition + " 	MATERIAL	='"	+	MATERIAL	+	"',";}
		if(	CORROSION_FATIGUE	!= null   ) {	condition = condition + " 	CORROSION_FATIGUE	='"	+	CORROSION_FATIGUE	+	"',";}
		if(	EQU_DESIGN_TEMP	!= null   ) {	condition = condition + " 	EQU_DESIGN_TEMP	='"	+	EQU_DESIGN_TEMP	+	"',";}
		if(	DESIGN_PRESSURE_RANGE	!= null   ) {	condition = condition + " 	DESIGN_PRESSURE_RANGE	='"	+	DESIGN_PRESSURE_RANGE	+	"',";}
		if(	SURFACE_HEAT_TRANSFER	!= null   ) {	condition = condition + " 	SURFACE_HEAT_TRANSFER	='"	+	SURFACE_HEAT_TRANSFER	+	"',";}
		if(	DESIGN_SHELL_PRES	!= null   ) {	condition = condition + " 	DESIGN_SHELL_PRES	='"	+	DESIGN_SHELL_PRES	+	"',";}
		if(	DESIGN_SHELL_TEMP	!= null   ) {	condition = condition + " 	DESIGN_SHELL_TEMP	='"	+	DESIGN_SHELL_TEMP	+	"',";}
		if(	DESIGN_TUBE_TEMP	!= null   ) {	condition = condition + " 	DESIGN_TUBE_TEMP	='"	+	DESIGN_TUBE_TEMP	+	"',";}
		if(	DESIGN_TUBE_PRES	!= null   ) {	condition = condition + " 	DESIGN_TUBE_PRES	='"	+	DESIGN_TUBE_PRES	+	"',";}
		if(	OPTION_SHELL_PRESS	!= null   ) {	condition = condition + " 	OPTION_SHELL_PRESS	='"	+	OPTION_SHELL_PRESS	+	"',";}
		if(	OPTION_SHELL_IN_TEMP	!= null   ) {	condition = condition + " 	OPTION_SHELL_IN_TEMP	='"	+	OPTION_SHELL_IN_TEMP	+	"',";}
		if(	OPTION_SHELL_OUT_TEMP	!= null   ) {	condition = condition + " 	OPTION_SHELL_OUT_TEMP	='"	+	OPTION_SHELL_OUT_TEMP	+	"',";}
		if(	OPTION_SHELL_MEDUIM	!= null   ) {	condition = condition + " 	OPTION_SHELL_MEDUIM	='"	+	OPTION_SHELL_MEDUIM	+	"',";}
		if(	OPTION_TUBE_IN_TEMP	!= null   ) {	condition = condition + " 	OPTION_TUBE_IN_TEMP	='"	+	OPTION_TUBE_IN_TEMP	+	"',";}
		if(	OPTION_TUBE_OUT_TEMP	!= null   ) {	condition = condition + " 	OPTION_TUBE_OUT_TEMP	='"	+	OPTION_TUBE_OUT_TEMP	+	"',";}
		if(	OPTION_TUBE_MEDUIM	!= null   ) {	condition = condition + " 	OPTION_TUBE_MEDUIM	='"	+	OPTION_TUBE_MEDUIM	+	"',";}
		if(	SHELL_MATERIAL	!= null   ) {	condition = condition + " 	SHELL_MATERIAL	='"	+	SHELL_MATERIAL	+	"',";}
		if(	TUBE_MATERIAL	!= null   ) {	condition = condition + " 	TUBE_MATERIAL	='"	+	TUBE_MATERIAL	+	"',";}
		if(	HIGH_LEFT	!= null   ) {	condition = condition + " 	HIGH_LEFT	='"	+	HIGH_LEFT	+	"',";}
		if(	DISPLACEMENT	!= null   ) {	condition = condition + " 	DISPLACEMENT	='"	+	DISPLACEMENT	+	"',";}
		if(	SPINDLE_SPEED	!= null   ) {	condition = condition + " 	SPINDLE_SPEED	='"	+	SPINDLE_SPEED	+	"',";}
		if(	IMPELLER_MEDUIM	!= null   ) {	condition = condition + " 	IMPELLER_MEDUIM	='"	+	IMPELLER_MEDUIM	+	"',";}
		if(	SPINDLE_MEDUIM	!= null   ) {	condition = condition + " 	SPINDLE_MEDUIM	='"	+	SPINDLE_MEDUIM	+	"',";}
		if(	PUMP_MEDUIM	!= null   ) {	condition = condition + " 	PUMP_MEDUIM	='"	+	PUMP_MEDUIM	+	"',";}
		if(	WIND_PRESSURE	!= null   ) {	condition = condition + " 	WIND_PRESSURE	='"	+	WIND_PRESSURE	+	"',";}
		if(	ENGINE_NUMBER	!= null   ) {	condition = condition + " 	ENGINE_NUMBER	='"	+	ENGINE_NUMBER	+	"',";}
		if(	LICENSE_NUMBER	!= null   ) {	condition = condition + " 	LICENSE_NUMBER	='"	+	LICENSE_NUMBER	+	"',";}
		if(	CHASSIS_NUMBER	!= null   ) {	condition = condition + " 	CHASSIS_NUMBER	='"	+	CHASSIS_NUMBER	+	"',";}
		if(	ENERGY_CONSUMPTION	!= null   ) {	condition = condition + " 	ENERGY_CONSUMPTION	='"	+	ENERGY_CONSUMPTION	+	"',";}
		if(	ENERGY_CONSUMPTION_CAT	!= null   ) {	condition = condition + " 	ENERGY_CONSUMPTION_CAT	='"	+	ENERGY_CONSUMPTION_CAT	+	"',";}
		if(	EQU_MEMO_TWO	!= null   ) {	condition = condition + " 	EQU_MEMO_TWO	='"	+	EQU_MEMO_TWO	+	"',";}
		if(	EQU_MEMO_THREE	!= null   ) {	condition = condition + " 	EQU_MEMO_THREE	='"	+	EQU_MEMO_THREE	+	"',";}
		if(	EQU_WHETHER_PERIODIC	!= null   ) {	condition = condition + " 	EQU_WHETHER_PERIODIC	='"	+	EQU_WHETHER_PERIODIC	+	"',";}
		if(	EQUIPMENT_ATTACH_URL	!= null   ) {	condition = condition + " 	EQUIPMENT_ATTACH_URL	='"	+	EQUIPMENT_ATTACH_URL	+	"',";}
